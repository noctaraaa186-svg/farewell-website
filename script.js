...
var POLAROID_DATA = [
  { img: 'images/posda13.jpg', caption: '✦ memories', rot: -9,  x: -220, y: -120 },
  { img: 'images/posda14.jpg', caption: 'together',   rot:  9,  x:  200, y: -120 },
  { img: 'images/posda15.jpg', caption: 'POSDA 25',   rot: -9,  x: -220, y:  120 },
  { img: 'images/posda16.jpg', caption: 'always',     rot:  11, x:  200, y:  120 },
  { img: 'images/posda17.jpg', caption: '♡',          rot: 0, x:  -10, y: -160 },
  { img: 'images/posda18.jpg', caption: 'forever',    rot:  0,  x:   -10, y:   100 }
];
...
function showFlowerRainTransition(callback) {
  ...
  for (var i = 0; i < count; i++) {
    (function(idx) {
      ...
      var baseSize = 44 + Math.random() * 60;
